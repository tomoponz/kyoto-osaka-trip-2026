window.TRIP_DATA = {
  ...
  days: [
    ...
    },
    {
      ...
      lead:'午前は嵐山を約2時間半探索。13:00頃から映画村を本線にして、16:50撤収を上限に伊丹20:05発を守る。',
      ...
      events:[
        ...
        {time:'08:30〜09:20目安',title:'嵐山へ移動',detail:'朝食は出発前に短く済ませるか移動中に調整。当日の交通状況を見てJR等を選択。',mapQuery:'嵐山 竹林の小径',type:'move'},
        {time:'09:20〜11:50目安',title:'嵐山を探索',detail:'約2時間30分。竹林の小径を軸に、渡月橋・桂川沿い・商店街などを体力と混雑に応じて回る。映画村の時間を守るため11:50を撤収目安にする。',mapQuery:'嵐山 竹林の小径',type:'spot'},
        {time:'11:50〜12:30目安',title:'昼食',detail:'嵐山周辺で時間優先。待ち時間が長い店は避ける。',mapQuery:'嵐山',type:'food'},
        {time:'12:30〜13:00目安',title:'嵐山 → 東映太秦映画村',detail:'13:00頃の入村を目標。',mapQuery:'東映太秦映画村',type:'move'},
        {time:'13:00〜16:50',title:'東映太秦映画村',detail:'9/10午後の本線。約3時間50分を確保し、16:50を撤収上限として帰りの飛行機を優先する。',mapQuery:'東映太秦映画村',official:'https://www.eigamura.com/',type:'spot'},
  ...
  spots: [
    ...
    {name:'嵐山・竹林の小径',area:'嵐山',category:'観光',status:'本線',price:'無料',note:'9/10午前。約2時間30分を確保し、竹林・渡月橋・桂川沿い・商店街を中心に探索。',mapQuery:'嵐山 竹林の小径'},
