...
Last updated: 2026-09-02 17:11 JST
...
- `NOT_STARTED`: 未調査
- `IN_PROGRESS`: 調査中
- `RESEARCHED`: 現地実用レベルまで調査済み。ただし直前確認項目あり
- `NEEDS_UPDATE`: 重要情報の鮮度または根拠が不足
- `VERIFIED`: 旅行直前の一次情報再確認まで完了

## Selection rule

原則として `trip-data.js` の固定事項 → 本線 → 飲食・ホテル → 有力候補 → その他候補の順で、1 cycleにつき1施設を深掘りする。
